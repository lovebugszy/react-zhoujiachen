...
class dangerReportList extends Component {
    constructor(props) {
        super(props)
        this.state = {
            content: 0,
    ...
    fetchData = () => {
        ...
        fetchPost(api.reportentry, params).then(res => {
            ...
            if (code === "1000") {
                this.setState({
                    dangerReportList: res.data.list,
        ...
        return (
            <div className="m-output-wrap">
                ...
                <div className="m-output-list-wrap">
                    <Tab content={<TabItem dangerReportList={this.state.dangerReportList}
...
export default dangerReportList;