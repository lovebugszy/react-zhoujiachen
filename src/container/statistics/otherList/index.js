...
class otherReportList extends Component {
    constructor(props) {
        super(props)
        this.state = {
            content: 0,
    ...
    fetchData = () => {
        const params = {
            "subservice": "otherDealStatistics",
            "params": {
        ...
        return (
            <div className="m-output-wrap">
                ...
                <div className="m-output-list-wrap">
                    <Tab content={<TabItem otherReportList={this.state.otherReportList}
