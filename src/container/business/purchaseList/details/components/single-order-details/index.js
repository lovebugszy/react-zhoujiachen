    ...
    render() {
        ...
        return (
            <div className="single-order-details clearfix">
                ...
                <ul className="list-ul">
                    <li className="top"/>
                    <span style={{marginLeft:'-50px',marginTop:'10px',fontSize:'16px'}}>供应商</span>   <li className="clientName text-overflow">{details.clientName}</li>
