...
class BuyList extends Component {
    ...
    fetchData = () => {
        ...
        fetchPost(api.buyList, params).then(res => {
            const code = res.code;
            if (code === "1000") {
                this.setState({
                    buyList: res.data.orderList,
    ...
    render() {
        const navList = ['全部', '待审核', '待退货', '异常完成', '已完成', '已取消'];
        return (
            <div className="m-output-wrap">
                ...
                <div className="m-output-list-wrap">
                    <Tab navList={navList}
                         content={<TabItem buyList={this.state.buyList}
