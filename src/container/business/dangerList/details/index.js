...
class dangerDetail extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    fetchOutputDynamic = () => {
        ...
        fetchDynamic(orderCode, 8, code).then(res => {
            let list = res.data;
    ...
    render() {
        ...
        listBottom = <div>
            <div className="li">
                <span>报损金额：</span><span> {details.refund}</span>
            </div>
            <div className="li">
                <span>报损原因：</span><span> {details.reason}</span>
            </div>
        ...
        return (
            <div className="m-output-detail-wrap">
                ...
                <div className="m-output-detail-inner">
                    <Title title="货损赔偿单详情"
                           subTitle={{assgin1: '货损赔偿单', assgin2: '货损赔偿单详情', Link: '/m/business/dangerList'}}/>
