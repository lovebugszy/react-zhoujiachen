...
class TabItem extends Component {
    ...
    render() {
        const {reportDangerList} = this.props;
        const trs = reportDangerList.map((v, i) => {
            return (
                <tr key={i} className="outList-tr">
                    ...
                    <td className="td outList-td">
                        ...
                        <p>({v.goodsPackage ? v.goodsPackage : '' };{v.goodsUnit ? v.goodsUnit : ''};{v.goodsSpec ? v.goodsSpec : ''})</p>
                    </td>
                    <td className="td outList-td">
                    ...
                    <td className="td outList-td">
                        <p className="left">{v.goodsPrice ? v.goodsPrice : '-'}</p>
                    </td>
                    <td className="td outList-td">
                        <p className="left">{v.money ? v.money : '-' }</p>
                    </td>
                    <td className="td">
