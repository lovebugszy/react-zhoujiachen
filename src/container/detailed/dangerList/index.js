...
class reportDangerList extends Component {
    constructor(props) {
        super(props)
        this.state = {
            content: 0,
    ...
    fetchData = () => {
        ...
        fetchPost(api.reportentry, params).then(res => {
            ...
            if (code === "1000") {
                this.setState({
                    reportDangerList: res.data.list,
...
export default reportDangerList;