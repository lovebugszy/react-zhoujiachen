...
class reportOtherList extends Component {
    constructor(props) {
        super(props)
        this.state = {
            content: 0,
        ...
        return (
            <div className="m-output-wrap">
                ...
                <div className="m-output-list-wrap">
                    <Tab content={<TabItem reportOtherList={this.state.reportOtherList}
...
export default reportOtherList;